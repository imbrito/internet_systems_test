...
RSpec.describe ClassroomsController, type: :controller do
  ...
  let(:valid_attributes) { FactoryGirl.build(:classroom).attributes }

  let(:invalid_attributes) { FactoryGirl.build(:invalid_classroom).attributes }
  ...
  let(:classroom) { Classroom.create(:student_id => student.id, :course_id => course.id) }

  describe "GET #index" do
    before { get :index, {:locale => 'en'}, valid_session }
  ...
  describe "GET #show" do
    before { get :show, {:locale => 'en', :id => classroom.to_param}, valid_session }
  ...
  describe "GET #new" do
    before { get :new, {:locale => 'en'}, valid_session }
  ...
  describe "GET #edit" do
    before { get :edit, {:locale => 'en', :id => classroom.to_param}, valid_session }
    it "assigns the requested classroom as @classroom" do
      expect(assigns(:classroom)).to eq(classroom)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Classroom" do
        expect {
          post :create, {:locale => 'en', :classroom => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      before { post :create, {:locale => 'en', :classroom => invalid_attributes}, valid_session }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) { FactoryGirl.build(:classroom).attributes }
      before { put :update, {:locale => 'en', :id => classroom.to_param, :classroom => new_attributes}, valid_session }
    ...
    context "with invalid params" do
      before { put :update, {:locale => 'en', :id => classroom.to_param, :classroom => invalid_attributes}, valid_session }
  ...
  describe "DELETE #destroy" do
    it "destroys the requested classroom" do
      ...
      expect {
        delete :destroy, {:locale => 'en', :id => classroom.to_param}, valid_session
      }.to change(Classroom, :count).by(-1)
    end
